...
export const formatZonedDateTimeToCustomString = (zonedDateTime: ZonedDateTime): string => {
  ...
  const millisecond = String(zonedDateTime.millisecond).padStart(3, '0').slice(0, 2); // Get 2 digits for milliseconds
